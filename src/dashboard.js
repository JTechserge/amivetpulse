import { PEOPLE, ASV_PEOPLE, allPeople,
...
import {
  setupLeaveRequests,
  countPendingLeaveRequests, renderLeaveRequestsPage, renderGroupConges,
  isReposLabel, collectAllLeaveGroups, collectAllChangeRequests, sortLeaveGroups,
  decideLeaveGroup, easterDate, getJoursFeries, getCPTakenDays, cpPeriodISO,
  getCPAcquired, openCPAdjustModal, getAbsenteeismRate, renderDashboardAbsences,
...
export {
  ...
  isReposLabel, collectAllLeaveGroups, collectAllChangeRequests, sortLeaveGroups,
  decideLeaveGroup, easterDate, getJoursFeries, getCPTakenDays, cpPeriodISO,
  getCPAcquired, renderGroupConges, openCPAdjustModal, getAbsenteeismRate,
